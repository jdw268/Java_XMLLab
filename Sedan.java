...
public class Sedan extends Vehicle {
	...
	//construtor method
	public Sedan(String makeInput, String modelInput, String[] optionsInput, String[] partsInput, double priceInput,
							Boolean hatchBackInput, int engineInput){
